...
<script type="text/javascript" src="{{asset('assets/js/pages/signature/wgssSigCaptX.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/js/pages/signature/SigCaptX-Globals.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/js/pages/signature/base64.js')}}"></script>
