    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <button
          ...
          @click="getSignature()"
        >
        <i class="fa fa-floppy-o" _v-3293cf8f=""></i> Add Patient Signature
        </button>
      </div>
...
function wizPin() {
  ...
  function onAddInputEcho(wizCtlV, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl AddInputEcho";
      wizCtlV.Display(onDisplay);
    } else {
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl AddInputEcho error";
    }
  }
  ...
  function onPutMaxLengthInputObj(inputObjV, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      ...
      document.getElementById("statusText").innerHTML +=
        "<br>InputObj PutMaxLength error";
    }
  }
  ...
  function onPutMinLengthInputObj(inputObjV, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      document.getElementById("statusText").innerHTML +=
        "<br>InputObj PutMinLength";
      inputObjV.PutMaxLength(4, onPutMaxLengthInputObj);
    } else {
      document.getElementById("statusText").innerHTML +=
        "<br>InputObj PutMinLength error";
    }
  }
  ...
  function onGetPropertyInputObj(inputObjV, property, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      document.getElementById("statusText").innerHTML +=
        "<br>InputObj GetProperty";
      inputObjV.PutMinLength(1, onPutMinLengthInputObj);
    } else {
      document.getElementById("statusText").innerHTML +=
        "<br>InputObj GetProperty error";
    }
  }
  ...
  function onConstructorInputObj(inputObjV, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      document.getElementById("statusText").innerHTML +=
        "<br>InputObj Constructor";
      inputObjV.Clear(onClearInputObj);
    } else {
      document.getElementById("statusText").innerHTML +=
        "<br>InputObj Constructor error";
    }
  }
  ...
  function onAddObjectText(wizCtlG, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      ...
      if (this.pad.Width == 396 && this.pad.Height == 100) {
        ...
        // This is a 430
        this.pad.x.num =
          this.pad.Width / 2 - this.pad.KeyWidth / 2 - 2 * this.pad.KeyWidth;
        this.pad.y.num = this.pad.Height / 2;
      } else {
        this.pad.x.num =
          this.pad.Width / 2 - this.pad.KeyWidth / 2 - 2 * this.pad.KeyWidth;
  ...
  function onGetPadWidth(wizCtlG, width, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      ...
      document.getElementById("statusText").innerHTML +=
        "<br>Pad height and width: " + this.pad.Height + " " + this.pad.Width;
  ...
  function onGetPadHeight(wizCtlG, height, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl onGetPadHeight";
      this.pad.Height = height;
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl onGetPadHeight: " + this.pad.Height;
      wizCtlG.GetPadWidth(onGetPadWidth);
    } else {
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl onGetPadHeight failed";
    }
  }
  ...
  function onReset(wizCtlG, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      ...
      document.getElementById("statusText").innerHTML +=
        "<br>Setting font size to " + this.pad.TextSize;
  ...
  function onClose(wizCtlG, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl window closed";
    } else {
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl Close failed";
    }
  }
  ...
  function onPadConnect(wizCtlG, padConnect, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status && 1 == padConnect) {
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl PadConnect";
      wizCtlG.Reset(onReset);
    } else {
      wizCtlG.Close(onClose);
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl PadConnect failed, closing window";
    }
  }
  ...
  function onPutVisibleWindow(wizCtlG, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl window set visible";
      wizCtlG.PadConnect(onPadConnect);
    } else {
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl PutVisibleWindow error";
    }
  }
  ...
  function onWizCtlPutLicence(wizCtlG, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl licence set successfully";
      wizCtlG.PutVisibleWindow(true, onPutVisibleWindow);
    } else {
      document.getElementById("statusText").innerHTML +=
        "WizCtl licensing error: " + status;
    }
  }
  ...
  function onSigCtlPutLicence(sigCtlV, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      document.getElementById("statusText").innerHTML +=
        "<br>SigCtl licence set successfully";
      this.wizCtl = new wgssSignatureSDK.WizCtl(onCreateWizCtl);
    } else {
      document.getElementById("statusText").innerHTML +=
        "SigCtl licensing error: " + status;
    }
  }
...
function wizCapture() {
  ...
  function onRenderBitmap(sigObjV, bmpObj, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      if (bmpObj.isBase64) {
        document.getElementById("statusText").innerHTML +=
          "<br>Base64 bitmap retrieved:<br>";
        document.getElementById("statusText").innerHTML +=
          "<br>" + bmpObj.image.src;
      } else {
        document.getElementById("statusText").innerHTML +=
          "<br>Bitmap retrieved, rendering image...";
      }
      ctx.drawImage(bmpObj.image, 0, 0);
    } else {
      document.getElementById("statusText").innerHTML +=
        "<br>Signature Render Bitmap error: " + status;
    }
  }
  ...
  function onGetSignature(sigCtlV, sigObjV, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      document.getElementById("statusText").innerHTML +=
        "<br>Rendering Signature into bitmap";
      var flags =
  ...
  function onCloseWizard(wizCtlG, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      document.getElementById("statusText").innerHTML +=
        "<br>Retrieving signature";
      sigCtl.GetSignature(onGetSignature);
    } else {
      document.getElementById("statusText").innerHTML +=
        "<br>Error closing wizard";
    }
  }
  ...
  function onAddOk(wizCtlG, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl Add Ok Button";
      wizCtlG.PutZoom(100, onPutZoom);
    } else {
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl Add Ok Button failed";
    }
  }
  ...
  function onAddClear(wizCtlG, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      ...
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl Add Clear Button failed";
    }
  }
  function onAddCancel(wizCtlG, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl Add Cancel Button";
      var xVar = new wgssSignatureSDK.Variant();
      var yVar = new wgssSignatureSDK.Variant();
      var objData = new wgssSignatureSDK.Variant();
      var options = new wgssSignatureSDK.Variant();
      ...
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl Add Cancel Button failed";
    }
  }
  function onPutWho(wizCtlG, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl Add who text";
      var xVar = new wgssSignatureSDK.Variant();
      var yVar = new wgssSignatureSDK.Variant();
      var objData = new wgssSignatureSDK.Variant();
      var options = new wgssSignatureSDK.Variant();
      ...
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl Add who text failed";
    }
  }
  function onPutWhy(wizCtlG, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl Add why text";
      var xVar = new wgssSignatureSDK.Variant();
      var yVar = new wgssSignatureSDK.Variant();
      var objData = new wgssSignatureSDK.Variant();
      var options = new wgssSignatureSDK.Variant();
  ...
  function onPutSignature(wizCtlG, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl Add Signature Object";
      var xVar = new wgssSignatureSDK.Variant();
      var yVar = new wgssSignatureSDK.Variant();
      var objData = new wgssSignatureSDK.Variant();
      var options = new wgssSignatureSDK.Variant();
      ...
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl Add Signature Object failed";
    }
  }
  ...
  function onGetFont(wizCtlG, font, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      ...
      document.getElementById("statusText").innerHTML +=
        "<br>Variant type " + font.type;
      document.getElementById("statusText").innerHTML +=
        "<br>Font name " + font.fontName;
      document.getElementById("statusText").innerHTML +=
        "<br>Font size " + font.fontSize;
      var xVar = new wgssSignatureSDK.Variant();
      var yVar = new wgssSignatureSDK.Variant();
      var objData = new wgssSignatureSDK.Variant();
      var options = new wgssSignatureSDK.Variant();
  ...
  function onGetPadWidth(wizCtlG, width, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      ...
      // Font sizes depend on the pad height and width
      document.getElementById("statusText").innerHTML +=
        "<br>Pad height and width: " + padHeight + " " + padWidth;
  ...
  function onGetPadHeight(wizCtlG, height, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      padHeight = height;
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl onGetPadHeight: " + padHeight;
      wizCtlG.GetPadWidth(onGetPadWidth);
    } else {
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl onGetPadHeight failed";
  ...
  function onWizCtlPutLicence(wizCtlG, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl licence created";
      wizCtlG.PutVisibleWindow(true, onPutVisibleWindow);
    } else {
      document.getElementById("statusText").innerHTML +=
        "<br>WizCtl licensing error";
    }
  }
...
function captureSignature() {
  ...
  function onPutSigData(sigObjV, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      document.getElementById("statusText").innerHTML +=
        "<br>PutSigData called";
    } else {
      document.getElementById("statusText").innerHTML +=
        "<br>error on PutSigData: " + status;
    }
  }
  ...
  function onGetAdditionalData(sigObjV, additionalData, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      document.getElementById("statusText").innerHTML +=
        "<br>Additional Data/MachineOS: " + additionalData;
      sigObjV.GetSigText(onGetSigText);
    } else {
      document.getElementById("statusText").innerHTML +=
        "<br>error on GetAdditionalData: " + status;
    }
  }
  ...
  function onRenderBitmap(sigObjV, bmpObj, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      ...
      ctx.drawImage(bmpObj.image, 0, 0);
      sigObjV.GetAdditionalData(
        wgssSignatureSDK.CaptData.CaptMachineOS,
        onGetAdditionalData
      );
    } else {
      document.getElementById("statusText").innerHTML +=
  ...
  function onPutExtraData(sigObjV, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      ...
      document.getElementById("statusText").innerHTML +=
        "<br>Signature PutExtraData error: " + status;
    }
  }
  ...
  function onDynCaptCapture(dynCaptV, sigObjV, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      document.getElementById("statusText").innerHTML +=
        "<br>Adding extra data";
      sigObjV.PutExtraData("extra key", "extra value", onPutExtraData);
    } else if (1 == status) {
      document.getElementById("statusText").innerHTML +=
        "<br>Signature capture cancelled by the user";
    } else {
      document.getElementById("statusText").innerHTML +=
        "<br>Signature capture error: " + status;
    }
  }
  ...
  function onSigCtlPutLicence(sigCtlV, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      dynCapt.Capture(
        sigCtlV,
        "RICKY PANDEY",
        "I hereby authorize NPHL to perform requested tests.",
        null,
        null,
        onDynCaptCapture
      );
      ...
      document.getElementById("statusText").innerHTML +=
        "<br>SigCtl constructor error: " + status;
    }
  }
  ...
  function onDynCaptConstructor(dynCaptV, status) {
    if (wgssSignatureSDK.ResponseStatus.OK == status) {
      ...
      document.getElementById("statusText").innerHTML +=
        "<br>Dynamic Capture constructor error: " + status;
      if (wgssSignatureSDK.ResponseStatus.INVALID_SESSION == status) {
